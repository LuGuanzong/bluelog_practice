...
def register_commands(app):
    ...
    def init(username, password):
        ...
        if admin is not None:
            ...
            admin = Admin(
                username=username,
                blog_title='Bluelog',
                blog_sub_title='This is blog_sub_title.',
                name='Admin',
                about="This is admin's about."
            )
            admin.set_password(password)
    ...
    @click.option('--comment', default=500, help='Quantiy of comment, default is 500')
    def forge(category, post, comment):
        ...
        click.echo('Generating %d commnets...' % comment)
